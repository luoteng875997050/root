...
<div class="wrap">
    <div class="content">
        <input type="text" id="username" value="请输入您的昵称" class="import box_style" onfocus="if(this.value==this.defaultValue){this.value=''}" onblur="if(this.value==''){this.value=this.defaultValue}"/>
        <input type="password" id="password" value="" class="import box_style" onfocus="if(this.value==this.defaultValue){this.value=''}" onblur="if(this.value==''){this.value=this.defaultValue}"/>
        <span class="tips"></span>
        <input type="button" value="加入我们" class="sub box_style" id="join_btn" req_url="<?php echo ($req_url); ?>"/>
    </div>
</div>
</body>
<!--全屏背景高度自适应-->
